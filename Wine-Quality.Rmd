...
The adjusted $R^2$ for this model is 0.3561. This is not a value indicative of a highly precise model. We are not concerned by the difrerence between $R^2$ and adjusted $R^2$ because they are so close together, at 0.3606 and  0.3561, respectively. 
